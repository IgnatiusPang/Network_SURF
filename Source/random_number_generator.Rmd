...
assign_random_number_each_time <- TRUE  # Change this 
...
my_sample_1_number <- partial ( sample_1_number, set_random_nubmer_seed= assign_random_number_each_time)

# Get the two lists of random numbers vectors
random_num_list_1 <- mclapply(1:3 , FUN=my_sample_1_number ,  mc.cores = number_of_cpu_cores) 
random_num_list_2 <- mclapply(4:6 , FUN=my_sample_1_number ,  mc.cores = number_of_cpu_cores) 
...
# Get the two lists of random numbers vectors
random_num_list_3 <- mclapply(1:3 , FUN=my_sample_1_number ,  mc.cores = number_of_cpu_cores) 
random_num_list_4 <- mclapply(4:6 , FUN=my_sample_1_number ,  mc.cores = number_of_cpu_cores) 
